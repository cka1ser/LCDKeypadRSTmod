/*
  ...
  LCDKeypadRSTmodRSTmod Arduino library
  https://github.com/cka1ser/LCDKeypadRSTmodRSTmod
  
  © 2024 Christian Kaiser.
  Based on the code by dzindra from https://github.com/dzindra/LCDKeypadRSTmod, 
...
#ifndef LCDKeypadRSTmod_h
#define LCDKeypadRSTmod_h
...
#define KEYPAD_TRESHOLD_RST 999 // added a treshold for the RST button

class LCDKeypadRSTmod : public LiquidCrystal
{
  public:
    LCDKeypadRSTmod();
    LCDKeypadRSTmod(uint8_t bl_pin, uint8_t button_apin);
